...
<aside class="main-sidebar sidebar-dark-primary text-white bg-lightblue disabled elevation-4 sidebar-no-expand">
  <!-- Brand Logo -->
  <a href="<?php echo base_url ?>admin" class="brand-link text-sm" style="background-color: #0d4da5;">
  ...
  <!-- Sidebar -->
  <div
    class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-transition os-host-scrollbar-horizontal-hidden"style="background-color: #0d4da5;">
    ...
    <div class="os-padding">
      <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
        <div class="os-content" style="padding: 0px 8px; height: 200%; width: 100%;">
          ...
          <nav class="mt-4">
            <ul
              ...
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>admin/?page=V_regestration" class="nav-link nav-V_regestration">
                  <i class="nav-icon fas fa-clipboard-list"style="font-size: 20px;"></i>
                  <p style="font-size: 17px;">
                    Vehicles Regestration
                  </p>
                </a>
              </li>
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>admin/?page=l_vehicles" class="nav-link nav-l_vehicles">
                  <i class="nav-icon fas fa-car"style="font-size: 20px;"></i>
                  <p style="font-size: 17px;">
                    Lost Vehicles
                  </p>
                </a>
              ...
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>admin/?page=l_document" class="nav-link nav-l_document">
              ...
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>admin/?page=offenses" class="nav-link nav-offenses">
                  <i class="nav-icon fas fa-traffic-light"style="font-size: 20px;"></i>
                   <p style="font-size: 17px;">
                    Offense Records
                  </p>
                </a>
              ...
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>admin/?page=maintenance/offenses"
                  class="nav-link nav-maintenance_offenses">
                  <i class="nav-icon fas fa-traffic-light"style="font-size: 20px;"></i>
                  <p style="font-size: 17px;">
                    Offenses List
                  </p>
